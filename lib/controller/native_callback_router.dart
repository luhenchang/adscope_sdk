...
/// 原生广告回调路由：单例 MethodChannel handler，按 [AMPSAdInstanceKey.adInstanceId] 分发到各 [AMPSNativeAd]。
class NativeCallbackRouter {
  NativeCallbackRouter._();

  static final NativeCallbackRouter instance = NativeCallbackRouter._();

  static const String _handlerKey = "native_callback_router";
